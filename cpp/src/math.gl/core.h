...
template <typename coord> class Matrix2;
...
template<class T> std::ostream &operator << (std::ostream &, Matrix4<T> &);
template<class T> std::istream &operator >> (std::istream &, Matrix4<T> &);
